...
for each scene and when to stop and change it.
...
var menu_music = load("res://title_screen/Audio/Music/MenuMusic.wav")
var map1_music = load("res://title_screen/Audio/Music/Map1Song.wav")
